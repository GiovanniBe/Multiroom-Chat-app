...
/**
 * handles chat message sent from a user
 * @param  {[type]} socket [description]
 * @return {[type]}        [description]
 */
...
/**
 * Allow a user to join an existing room or, if it doesn't yet exist,
 * to create it.
 * @param  {[type]} socket [description]
 * @return {[type]}        [description]
 */
...
/**
 * handling user disconnection when leaves the application chat
 * @param  {[type]} socket [description]
 * @return {[type]}        [description]
 */
